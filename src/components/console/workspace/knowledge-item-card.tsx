...
export function KnowledgeItemCard({ item }: KnowledgeItemCardProps) {
  ...
  return (
    <Card className="group hover:shadow-lg hover:border-primary/20 transition-all duration-300 hover:-translate-y-1 overflow-hidden relative">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="space-y-1 min-w-0">
            ...
            <a 
              ...
              className="block font-semibold hover:underline line-clamp-2 break-words text-base group-hover:text-primary transition-colors"
            >
